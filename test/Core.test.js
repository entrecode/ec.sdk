...
describe('Core', () => {
  ...
  it('should return traverson Builder follow cached', () => {
    ...
    return core.follow('ec:dm-stats').then(() =>
      core
        .follow('ec:dm-stats')
        .should.eventually.be.instanceOf(TraversonMock)
        .notify(() => stub.restore()),
  ...
  it('should return link', () => {
    ...
    return core
      .link('ec:dm-stats')
      .should.eventually.have.property('href', 'https://datamanager.entrecode.de/stats{?dataManagerID}');
  });
  ...
  it('should reject on link missing link', () => {
    ...
    return core
      .link('ec:dm-stats')
      .then(() =>
        core.link('missing').should.be.rejectedWith('Could not get missing. Link not present in root response.'),
      );
  });
  ...
  it('should preload schema', () => {
    nock('https://entrecode.de/').get('/schema/error').reply(200, {
  ...
  it('should preload schemas', () => {
    nock('https://entrecode.de/').get('/schema/error').times(2).reply(200, {
      $schema: 'http://json-schema.org/draft-04/schema#',
      id: 'https://entrecode.de/schema/error',
    });

    return core.preloadSchemas(['https://entrecode.de/schema/error', 'https://entrecode.de/schema/error']).should.be
      .fulfilled;
  });
  ...
  it('resourceList called with levels param', () => {
    ...
    return core.resourceList('dummy', { _levels: 2 }).should.be.rejectedWith('_levels on list resources not supported');
  });
...
describe('Network Helper', () => {
  ...
  describe('get', () => {
    it('should be resolved', () => {
      nock('https://entrecode.de').get('/').replyWithFile(200, `${__dirname}/mocks/dm-list.json`);
    ...
    it('should be resolved with token', () => {
      ...
      return helper.get('test', traversal).then(() => {
    ...
    it('should be resolved with token, first load from publicToken store', () => {
      ...
      return helper.get('testbeefbeef', traversal).then(() => {
        traversal.should.have.nested.property('requestOptions.headers.Authorization', `Bearer ${token}`);
      });
    });
    it('should be rejected', () => {
      nock('https://entrecode.de').get('/').reply(404, {
        title: 'not found',
        code: 2102,
        status: 404,
        detail: 'title',
    ...
    it('should be rejected, response no json', () => {
      nock('https://entrecode.de').get('/').reply(500, 'gateway timeout ladida');

      return helper.get('live', traversal).should.be.rejectedWith(Error);
    });
    it('should be rejected network error', () => {
      nock('https://entrecode.de').get('/').replyWithError('mocked error');
    ...
    it('should fire loggedOut event on ec.402 error', () => {
      nock('https://entrecode.de').get('/').reply(401, {
    ...
    it('should add custom user agent', () => {
      ...
      return helper.get('test', traversal).then(() => {
        traversal.should.have.nested.property(
          'requestOptions.headers.X-User-Agent',
          `test/0.0.1 ec.sdk/${packageJson.version}`,
        );
      });
    });
  ...
  describe('getUrl', () => {
    ...
    it('should be rejected', () => {
      ...
      return helper
        .getUrl('live', traversal.follow('ec:dm-stats'))
        .then(() => {
          throw new Error('unexpectedly resolved');
        })
        .catch((err) => {
  ...
  describe('getEmpty', () => {
    it('should be resolved', () => {
      nock('https://entrecode.de').get('/').reply(204);

      return helper.getEmpty('live', traversal).should.be.eventually.be.fulfilled;
    });
    it('should be rejected', () => {
      nock('https://entrecode.de').get('/').reply(404, 'mocked error');

      return helper
        .getEmpty('live', traversal)
        .then(() => {
          throw new Error('unexpectedly resolved');
        })
        .catch((err) => {
  ...
  describe('postEmpty', () => {
    it('should be resolved', () => {
      nock('https://entrecode.de').post('/').reply(204);

      return helper.postEmpty('live', traversal, {}).should.be.eventually.be.fulfilled;
    });
    it('should be rejected', () => {
      nock('https://entrecode.de').post('/').reply(404, 'mocked error');

      return helper
        .postEmpty('live', traversal, {})
        .then(() => {
          throw new Error('unexpectedly resolved');
        })
        .catch((err) => {
    ...
    it('should fire error event', () => {
      nock('https://entrecode.de').post('/').replyWithError('mocked error');
  ...
  describe('post', () => {
    it('should be resolved', () => {
      nock('https://entrecode.de').post('/').replyWithFile(200, `${__dirname}/mocks/dm-list.json`);
    ...
    it('should be rejected', () => {
      nock('https://entrecode.de').post('/').reply(404, {
        title: 'not found',
        code: 2102,
        status: 404,
        detail: 'title',
  ...
  describe('put', () => {
    it('should be resolved', () => {
      nock('https://entrecode.de').put('/').replyWithFile(200, `${__dirname}/mocks/dm-list.json`);

      return helper.put('live', traversal).should.be.eventually.be.fulfilled;
    });
    it('should be rejected', () => {
      nock('https://entrecode.de').put('/').reply(404, {
        title: 'not found',
        code: 2102,
        status: 404,
        detail: 'title',
    ...
    it('should fire error event', () => {
      nock('https://entrecode.de').put('/').replyWithError('mocked error');
  ...
  describe('delete', () => {
    it('should be resolved', () => {
      nock('https://entrecode.de').delete('/').reply(204);

      return helper.del('live', traversal).should.be.eventually.be.fulfilled;
    });
    it('should be rejected', () => {
      nock('https://entrecode.de').delete('/').reply(404, {
        title: 'not found',
        code: 2102,
        status: 404,
        detail: 'title',
    ...
    it('should fire error event', () => {
      nock('https://entrecode.de').delete('/').replyWithError('mocked error');
  ...
  describe('superagentFormPost', () => {
    it('should be resolved', () => {
      nock('https://entrecode.de').post('/').reply(200, { token: 'token' });
    ...
    it('should fire error event', () => {
      ...
      return helper
        .superagentFormPost('live', 'https://entrecode.de', {})
        .then(() => {
          throw new Error('unexpectedly resolved');
        })
        .catch((err) => {
  ...
  describe('superagentGet', () => {
    it('should be resolved', () => {
      nock('https://entrecode.de').get('/').reply(200, { url: 'http://example.com' });
    ...
    it('should be rejected', () => {
      nock('https://entrecode.de').get('/').reply(
        404,
        {
          title: 'not found',
          code: 2102,
    ...
    it('should fire error event', () => {
      ...
      return helper
        .superagentGet('https://entrecode.de', {})
        .then(() => {
          throw new Error('unexpectedly resolved');
        })
        .catch((err) => {
  ...
  describe('superagentPost', () => {
    it('should be resolved', () => {
      nock('https://entrecode.de').post('/').reply(200, {});

      return helper.superagentPost('live', superagent.post('https://entrecode.de')).should.be.eventually.be.fulfilled;
    });
    ...
    it('should be rejected', () => {
      ...
      return helper.superagentPost('live', superagent.post('https://entrecode.de')).should.be.rejectedWith(Problem);
    });
    it('should fire error event', () => {
      nock('https://entrecode.de').post('/').replyWithError('mocked error');

      return helper
        .superagentPost('live', superagent.post('https://entrecode.de'))
        .then(() => {
          throw new Error('unexpectedly resolved');
        })
        .catch((err) => {
  ...
  describe('superagentGetPiped', () => {
    it('should be resolved', () => {
      ...
      return helper.superagentGetPiped('https://entrecode.de/asset/download', fs.createWriteStream('/dev/null')).should
        .eventually.be.be.fulfilled;
    });
    it('should be rejected', () => {
      nock('https://entrecode.de').get('/asset/download').replyWithError('mocked error');

      return helper
        .superagentGetPiped('https://entrecode.de/asset/download', fs.createWriteStream('/dev/null'))
...
describe('optionsToQuery', () => {
  ...
  it('should encode fromEventNumbers map in buildEntriesRequestBody', () => {
    const map = {
      '11111111-1111-1111-1111-111111111111': null,
      '22222222-2222-2222-2222-222222222222': 'ts#entry#rn',
    };
    const body = helper.buildEntriesRequestBody(
      { fromEventNumbers: map, modelID: '11111111-1111-1111-1111-111111111111' },
      { dataManagerID: '00000000-0000-0000-0000-000000000001' },
    );
    body.should.have.property('fromEventNumbers');
    const decoded = JSON.parse(Buffer.from(body.fromEventNumbers, 'base64').toString('utf8'));
    decoded.should.deep.equal(map);
  });
  it('should pass through fromEventNumbers string in buildEntriesRequestBody', () => {
    const s = 'eyJhIjoxfQ';
    const body = helper.buildEntriesRequestBody(
      { fromEventNumbers: s, modelID: '11111111-1111-1111-1111-111111111111' },
      { dataManagerID: '00000000-0000-0000-0000-000000000001' },
    );
    body.should.have.property('fromEventNumbers', s);
  });
  it('should throw when fromEventNumber and fromEventNumbers are combined (POST body)', () => {
    const throws = () => {
      helper.validateHistoryEntriesPaginationOptions({
        fromEventNumber: 'a#b#c',
        fromEventNumbers: 'e30=',
  ...
  it('should throw when fromEventNumber is used with multiple modelIDs (POST body)', () => {
    const throws = () => {
      helper.validateHistoryEntriesPaginationOptions({
        modelID: 'a,b',
  ...
  it('should allow fromEventNumber with single modelID string in buildEntriesRequestBody', () => {
    const body = helper.buildEntriesRequestBody(
      {
        modelID: '11111111-1111-1111-1111-111111111111',
    ...
    body.should.have.property('fromEventNumber', 'ts#e#r');
  });
  ...
  describe('template validation', () => {
    it('valid, all types', () => {
      ...
      (() => helper.optionsToQuery(obj, '{?size,page,sort,field,fieldTo,fieldFrom,field~}')).should.not.throw();
    });
